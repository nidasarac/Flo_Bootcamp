...
class ViewController: UIViewController , UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout , UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Sports"
        sportsArr.append(Sports(sportName: "FootBall", sportPhoto: UIImage(named: "footballicon")!))
        sportsArr.append(Sports(sportName: "BasketBall", sportPhoto: UIImage(named: "basketballicon")!))
